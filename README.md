...
- Παραδείγματα κώδικα και εκπαιδευτικά προγράμματα
- Διαγράμματα κυκλωμάτων και σχηματικά

### Προαπαιτούμενα

**Μπορείτε να ακολουθήσετε το μάθημα με δύο τρόπους:**
...
- [Tinkercad Circuits](https://www.tinkercad.com/circuits) — online, δωρεάν, τρέχει σε browser
- [Wokwi](https://wokwi.com/) — online, δωρεάν, υποστηρίζει Serial Monitor
- Δεν απαιτείται εγκατάσταση ή υλικό — μόνο λογαριασμός

> Όλα τα παραδείγματα κώδικα λειτουργούν αυτούσια και στους εξομοιωτές.
