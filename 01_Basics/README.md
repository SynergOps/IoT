...
Σε αυτό το μάθημα, θα μάθουμε τα απολύτως βασικά για την πλατφόρμα του Arduino και τη δομή ενός προγράμματος (που ονομάζεται "sketch"). 
Δεν θα κάνουμε κάτι συναρπαστικό ακόμα, αλλά θα θέσουμε τις βάσεις για τα επόμενα βήματα.
...
Το Arduino είναι μια πλατφόρμα ανοιχτού κώδικα που αποτελείται από δύο μέρη:

1.  **Η πλακέτα (Hardware):** Ένας μικροελεγκτής (ο "εγκέφαλος") πάνω σε μια πλακέτα με διάφορες ακίδες (pins) για να συνδέουμε καλώδια, αισθητήρες, και άλλα ηλεκτρονικά. Για αυτά τα πρώτα μαθήματα, θα χρησιμοποιήσουμε μόνο την πλακέτα και το ενσωματωμένο της LED.
2.  **Το περιβάλλον ανάπτυξης (IDE - Software):** Ένα πρόγραμμα στον υπολογιστή μας όπου γράφουμε τον κώδικα, τον ελέγχουμε για λάθη και τον "φορτώνουμε" στην πλακέτα Arduino.
...
| Τιμή | Χρώματα (4 λωρίδες) | Χρώματα (5 λωρίδες) | Χρήση |
|------|---------|---------|-------|
| **220Ω** | 🔴 Κόκκινο - 🔴 Κόκκινο - 🟤 Καφέ | 🔴 Κόκκινο - 🔴 Κόκκινο - ⚫ Μαύρο - ⚫ Μαύρο | LED (κόκκινο/πράσινο/κίτρινο) |
| **330Ω** | 🟠 Πορτοκαλί - 🟠 Πορτοκαλί - 🟤 Καφέ | 🟠 Πορτοκαλί - 🟠 Πορτοκαλί - ⚫ Μαύρο - ⚫ Μαύρο | LED (μπλε/λευκό) |
| **10kΩ** | 🟤 Καφέ - ⚫ Μαύρο - 🟠 Πορτοκαλί | 🟤 Καφέ - ⚫ Μαύρο - ⚫ Μαύρο - 🔴 Κόκκινο | Pull-down για κουμπιά |
